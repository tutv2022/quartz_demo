...
public interface CustomTrigger extends Trigger {
     ...
     * situation, the <code>{@link CustomTrigger}</code> wants to be fired
     ...
     * <p>
     * Instructs the <code>{@link Scheduler}</code> that upon a mis-fire
     * situation, the <code>{@link CustomTrigger}</code> wants to be
    ...
    TriggerBuilder<CustomTrigger> getTriggerBuilder();
}
