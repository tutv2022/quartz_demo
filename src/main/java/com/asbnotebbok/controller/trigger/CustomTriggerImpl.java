 ...
 */
@Slf4j
public class CustomTriggerImpl extends AbstractTrigger<SimpleTrigger> implements SimpleTrigger, CoreTrigger {
     ...
     */
    @Deprecated
    public CustomTriggerImpl(String name) {
     ...
     */
    @Deprecated
    public CustomTriggerImpl(String name, String group) {
     ...
     */
    @Deprecated
    public CustomTriggerImpl(String name, int repeatCount, long repeatInterval) {
     ...
     */
    @Deprecated
    public CustomTriggerImpl(String name, String group, int repeatCount,
                             long repeatInterval) {
     ...
     */
    @Deprecated
    public CustomTriggerImpl(String name, Date startTime) {
     ...
     */
    @Deprecated
    public CustomTriggerImpl(String name, String group, Date startTime) {
     ...
     */
    @Deprecated
    public CustomTriggerImpl(String name, String group, String jobName,
    ...
    public void triggered(Calendar calendar) {
        ...
        int nCount = jobDataMap.getInt("repeat");
        int calender = jobDataMap.getInt("calender");
        List<Integer> elements = (List<Integer>)jobDataMap.get("elements");

        log.info("Repeat: {}", nCount);
    ...
    public Date computeFirstFireTime(Calendar calendar) {
        ...
        int nCount = getJobDataMap().getInt("repeat");
        int calenderSetting = getJobDataMap().getInt("calender");
        List<Integer> elements = (List<Integer>)getJobDataMap().get("elements");

        log.info("Repeat: {}", nCount);
        log.info("calender: {}", calenderSetting);
        log.info("elements: {}", elements);
        Date startDate = getStartTime();

        // 1 == WEEK
        if ( calenderSetting == 1 ) {
